...
export const notices = [
  ...
  { date: "১৮+ সেপ্টেম্বর ২০২৬", small: "(সম্ভাব্য তারিখ)", text: <>কার্যক্রম পুরোদমে শুরু হবে, যেখানে মালয়েশিয়ান নিয়োগকর্তারা কর্মী বরাদ্দ ও ই-এমপ্লয়ার মাধ্যমে অ্যাপ্লিকেশন জমা দিতে পারবেন।</> },
];
